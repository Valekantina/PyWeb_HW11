...
Revision ID: fg56aad33bcce
Revises: 
Create Date: 2023-05-08 09:05:28.500462
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_cats_description'), 'cats',
                    ['description'], unique=False)
    op.create_index(op.f('ix_cats_id'), 'cats', ['id'], unique=False)
    op.create_index(op.f('ix_cats_nickname'), 'cats',
